...
public class AfficheNotif extends Fragment
{
    ...
    private TextView exceptionNotification;
    public AfficheNotif()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        try
        {
            exceptionNotification=(TextView)v.findViewById(R.id.exceptionNotification);
        ...
        {
            exceptionNotification.setText("Aucune Notification");
        }
